import { createUser, getAllUsers, getUserByEmail, getUserById, updateUser } from "../models/userModel.mjs";
...
export const updateImage = async (req,res) => {
    ...
    // update user
    const updatedUser = await updateUser(req.user.id, {imagePath: req.body.imagePath})
    .then(user => {
        if(!user) return false
